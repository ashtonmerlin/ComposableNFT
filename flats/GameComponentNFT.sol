...
contract GameComponentNFT is ERC721, ERC2981 {
    ...
    function mint(string memory _tokenURI, uint256 baseId, uint256 mintRoyaltyFee, uint96 marketRoyaltyFraction) external payable {
        if (baseId != 0) {
